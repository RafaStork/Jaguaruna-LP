...
Domínio: https://jaguaruna.321modular.com.br/

Em Settings > Pages, use GitHub Actions. O workflow incluído prepara os caminhos e publica `_site`. O arquivo CNAME e `.nojekyll` devem ser preservados, assim como arquivos de verificação Google existentes.
